...
export const HeroParallax = ({ products }) => {
  ...
  return (
    <div
      ref={ref}
      className="h-[300vh] xs:h-[200] py-20 md:py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:800px] sm:[transform-style:preserve-3d]">
      <Header />
      <motion.div
        style={{
          rotateX,
