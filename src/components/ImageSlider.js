...
export function ImagesSliderDemo() {
  ...
  return (
    <ImagesSlider className="h-[40rem]" images={images}>
      ...
      >
        <motion.p
          className="font-bold text-xl md:text-3xl lg:text-6xl text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 py-4"
        >
          Learn More About Us <br /> Click Below
        </motion.p>
        <button
